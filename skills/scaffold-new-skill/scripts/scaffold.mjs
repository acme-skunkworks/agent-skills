...
//
//   - package.json   : name "@acme-studio/skill-<name>", private: true,
...
export function buildSkeleton(name, options = {}) {
  ...
  const packageJson = {
    ...
    bugs: {
      url: "https://github.com/acme-studio/agent-skills/issues",
    },
    description: `Agent skill: ${name}.`,
    engines: {
      node: ">=22",
    },
    homepage: `https://github.com/acme-studio/agent-skills/tree/main/skills/${name}#readme`,
    ...
    repository: {
      directory: base,
      type: "git",
      url: "https://github.com/acme-studio/agent-skills.git",
    },
...
\`\`\`bash
npx skills add https://github.com/acme-studio/agent-skills --skill ${name} --agent claude-code --copy
\`\`\`
