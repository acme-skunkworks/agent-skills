...
```bash
npx skills add https://github.com/acme-studio/agent-skills --skill changelog --agent claude-code --agent cursor --copy
```
...
maintained in the [`agent-skills`](https://github.com/acme-studio/agent-skills)
