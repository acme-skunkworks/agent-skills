 ...
 */
export function createDetectors({ repoRoot, linearFacts = {} }) {
  const cache = new Map();
  ...
  const registry = {
    ...
    linearWorkspaceSlug: () =>
      linearFacts.linearWorkspaceSlug ? { value: linearFacts.linearWorkspaceSlug } : null,
    ...
    bundleVersioning: () => {
      ...
      return root
        ? { value: { root, manifest: "package.json", skillFile: "SKILL.md" } }
        : null;
    },
