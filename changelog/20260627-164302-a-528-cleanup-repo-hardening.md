...
- **`cleanup-repo` filesystem hygiene is now CI-gated ([A-528](https://linear.app/rheged-studio/issue/A-528)).**
...
- **Per-pass confirmation and scope flags ([A-537](https://linear.app/rheged-studio/issue/A-537)).**
