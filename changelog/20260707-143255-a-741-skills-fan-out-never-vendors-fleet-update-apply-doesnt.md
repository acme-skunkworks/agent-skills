...
**Root cause — a regression from [A-730](https://linear.app/acme-skunkworks/issue/A-730) (#113).**
...
"up to date". But the repo-internal `scaffold-new-skill` ([A-729](https://linear.app/acme-skunkworks/issue/A-729))
